...
import { formatRelationshipType } from 'utilities/user-formatters'
...
class RecentMatchCard extends React.Component<PropsType, StateType> {
  static defaultProps = {
    foldable: false
  }
    ...
    return (
      <ProfileCardDiv foldable={this.props.foldable}>
        <InfoBannerDiv>
          ...
          <ProfileTextInfo user={this.props.user} hideContactInfo={false} />
        </InfoBannerDiv>
